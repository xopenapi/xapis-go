...
*SilkCodecApi* | [**DecodeSilkV3**](docs/SilkCodecApi.md#decodesilkv3) | **Post** /silk/v3/decode | 解码silk-v3格式的语音
*SilkCodecApi* | [**DecodeSilkV3ByURL**](docs/SilkCodecApi.md#decodesilkv3byurl) | **Get** /silk/v3/decode | 将链接解码silk-v3格式的语音
*SilkCodecApi* | [**EncodeSilkV3**](docs/SilkCodecApi.md#encodesilkv3) | **Post** /silk/v3/encode | 将语音编码为silk-v3格式
*SilkCodecApi* | [**EncodeSilkV3ByURL**](docs/SilkCodecApi.md#encodesilkv3byurl) | **Get** /silk/v3/encode | 将语音链接编码为silk-v3格式
*SmsApi* | [**SendSMS**](docs/SmsApi.md#sendsms) | **Post** /sms/v1/send | 发送短信
*StorageApi* | [**GetAudioInfo**](docs/StorageApi.md#getaudioinfo) | **Get** /storage/v1/audio_info | 获取音频信息
...
*StorageApi* | [**GetVideoInfo**](docs/StorageApi.md#getvideoinfo) | **Get** /storage/v1/video_info | 获取视频信息
*StorageApi* | [**GetVideoSnapshot**](docs/StorageApi.md#getvideosnapshot) | **Get** /storage/v1/video_snapshot | 获取视频截图
...
## Documentation For Models
 ...
 - [SendSMSResult](docs/SendSMSResult.md)
...
Note, each API key must be added to a map of `map[string]APIKey` where the key is: X-Client-ID and passed in as the auth context for each request.
